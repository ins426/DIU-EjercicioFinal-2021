...
|------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| HomePage               | Es la página de inicio, donde el usuario podrá ver los eventos destacados del mes, así como los últimos artículos de opinión.                                                                                                                                                                     |
| Cultura                | Se trata de un menú desplegable en el que se le mostrará al usuario todas las opciones de la página referentes a cultura como la sección de eventos culturales o la descarga de la revista de la página web.                                                                                  |
| Eventos                | Es una de las secciones pertenecientes al menú desplegable de cultura donde el usuario podrá visualizar el listado de los próximos eventos culturales.                                                                                                                                           |
| Evento                 | Es la página asociada a un evento donde se darán detalles del evento como fecha, hora, organizador, lugar y enlaces externos al organizador.                                                                                                                                                     |
| <img src="Rediseño/compartir.png" width="50" />              | Esta opción se puede encontrar tanto en la página de un evento como en la página de un espacio cultural, su función en compartir en distintas redes sociales el link a dicha página.                                                                                                             |
| Comprar Entradas       | Esta etiqueta se encuentra en cada página de cada evento, su función es acceder a la página de compra de entradas donde el usuario deberá de escribir sus credenciales, número de entradas a comprar y número de tarjeta de crédito para hacer la compra online de las entradas a un evento. |
| Artículos de opinión   | Se trata de una sección dentro del menú desplegable de Cultura donde el usuario podrá visualizar los artículos de opinión sobre distintos temas culturales.                                                                                                                                      |
| Descargar Revista      | Esta opción que se encuentra dentro del menú desplegable de cultura permite al usuario descargar la revista mensual de la página.                                                                                                                                                                |
| Espacios Culturales    | Se trata de una opción dentro del menú desplegable Cultura donde se muestra un listado de los distintos espacios culturales situados en las distintas ciudades en las que trabaja Yuzin.                                                                                                         |
| Espacio Cultural       | Es la página asociada a uno de los espacios culturales mostrados en la sección Espacios Culturales. En esta página se dará una descripción del sitio, información de contacto y enlaces externos a dicho espacio cultural.                                                                       |
| Subir tu Evento        | Con esta sección encontrada en el menú de cabecera de la página el usuario podrá acceder a un formulario donde podrá solicitar la publicación de su evento en la web.                                                                                                                            |
| El club                | Este menú desplegable encontrado en el menú de la cabecera agrupa las opciones referentes al club de la página, como son la newsletter o el hacerse miembro.                                                                                                                                     |
| Newsletter             | Opción por la cual el usuario accederá a un formulario para suscribirse a la newsletter de la página.                                                                                                                                                                                                |
| Hazte miembro          | Opción por la cual el usuario accederá al catálogo de las distintas suscripciones disponibles en la página. Tras seleccionar una opción el usuario deberá rellenar un formulario para convertirse en miembro del club de Yuzin.                                                                  |
| Iniciar Sesión         | A través de esta etiqueta un usuario miembro es redirigido a un formulario donde deberá de introducir su nombre de usuario y contraseña de miembro.                                                                                                                                              |
| Buscar                 | En esta etiqueta el usuario podrá hacer una búsqueda por palabras clave tanto de espacios culturales como de eventos, teniendo la opción a hacer un filtrado por tipo de eventos, fechas o lugar.                                                                                                |
...
Con este prototipo realizado en AdobeXd vemos que la web es muy mejorable en cuanto a estructura y jerarquía, además de que visualmente se consigue mayor comodidad para el usuario.

<p float="left">
<img src="Rediseño/wireframe_1.jpg" width="600"/>
<img src="Rediseño/wireframe_2.jpg" width="600"/>
<img src="Rediseño/wireframe_3.jpg" width="600"/>
</p>

## 3.CONCLUSIONES
En este ejercicio se han establecido las bases de una posible mejora para la página web de Yuzin, pero requeriría de más tiempo hacer un estudio más profundo y un rediseño más completo. Con el estudio realizado hemos obtenido los fallos y puntos fuertes de Yuzin en su nuevo diseño y se ha diseñado uno nuevo en base a los resultados. Con esto concluimos que Yuzin ha mejorado considerablemente su página web pasando de un diseño de 2003 a uno más actual intentando adaptarse a los nuevas tendencias en sitios web. Sin embargo, se queda a mitad de camino de lograrlo debido a la falta de simetría, contrastes, feedback al usuario o fallos en su funcionalidad. Es por esto que requiere de un nuevo diseño en el que se de accesibilidad a todo el mundo y se mejoren todos los fallos comentados durante el ejercicio. 
