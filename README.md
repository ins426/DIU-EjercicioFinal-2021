...
| Cultura                | Se trata de un menú desplegable en el que se le mostrará al usuario todas las opciones de <br>la página referentes a cultura como la sección de eventos culturales o la descarga de la<br>revista de la página web.                                                                                  |
| Eventos                | Es una de las secciones pertenecientes al menú desplegable de cultura donde el usuario podrá <br>visualizar el listado de los próximos eventos culturales.                                                                                                                                           |
| Evento                 | Es la página asociada a un evento donde se darán detalles del evento como fecha, hora, organizador, lugar <br>y enlaces externos al organizador.                                                                                                                                                     |
| Compartir              | Esta opción se puede encontrar tanto en la página de un evento como en la página de un espacio cultural, <br>su función en compartir en distintas redes sociales el link a dicha página.                                                                                                             |
| Comprar Entradas       | Esta etiqueta se encuentra en cada página de cada evento, su función es acceder a la página de compra de <br>entradas donde el usuario deberá de escribir sus credenciales, número de entradas a comprar y <br>número de tarjeta de crédito para hacer la compra online de las entradas a un evento. |
| Artículos de opinión   | Se trata de una sección dentro del menú desplegable de Cultura donde el usuario podrá visualizar los artículos de <br>opinión sobre distintos temas culturales.                                                                                                                                      |
| Descargar Revista      | Esta opción que se encuentra dentro del menú desplegable de cultura permite al usuario descargar la revista <br>mensual de la página.                                                                                                                                                                |
| Espacios Culturales    | Se trata de una opción dentro del menú desplegable Cultura donde se muestra un listado de los distintos espacios <br>culturales situados en las distintas ciudades en las que trabaja Yuzin.                                                                                                         |
| Espacio Cultural       | Es la página asociada a uno de los espacios culturales mostrados en la sección Espacios Culturales. En esta página <br>se dará una descripción del sitio, información de contacto y enlaces externos a dicho espacio cultural.                                                                       |
| Subir tu Evento        | Con esta sección encontrada en el menú de cabecera de la página el usuario podrá acceder a un formulario donde podrá <br>solicitar la publicación de su evento en la web.                                                                                                                            |
| El club                | Este menú desplegable encontrado en el menú de la cabecera agrupa las opciones referentes al club de la página, como <br>son la newsletter o el hacerse miembro.                                                                                                                                     |
| Newsletter             | Opción por la cual el usuario accederá a un formulario para suscribirse a la newsletter de la página.                                                                                                                                                                                                |
| Hazte miembro          | Opción por la cual el usuario accederá al catálogo de las distintas suscripciones disponibles en la página. <br>Tras seleccionar una opción el usuario deberá rellenar un formulario para convertirse en miembro del club de Yuzin.                                                                  |
| Iniciar Sesión         | A través de esta etiqueta un usuario miembro es redirigido a un formulario donde deberá de introducir su nombre de <br>usuario y contraseña de miembro.                                                                                                                                              |
| Buscar                 | En esta etiqueta el usuario podrá hacer una búsqueda por palabras clave tanto de espacios culturales como de eventos, <br>teniendo la opción a hacer un filtrado por tipo de eventos, fechas o lugar.                                                                                                |
| Sobre Nosotros         | Es una de las opciones de menú desplegable perteneciente al menú de cabecera. En esta sección encontraremos información de <br>la empresa y de contacto.                                                                                                                                             |
